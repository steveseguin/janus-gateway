...
- Uses janus.js from existing demos

**Phase 8 completed — E2E Tests:**
- Playwright test suite (server health, echotest, videoroom, streaming)
- GitHub Actions workflow (.github/workflows/e2e-ci.yml)

**Current test count: 220 Rust unit/integration tests, all passing.**
