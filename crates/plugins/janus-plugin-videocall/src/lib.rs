//! Janus VideoCall plugin — peer-to-peer video calls (stub).
...
#[no_mangle]
pub extern "C" fn janus_plugin_videocall_create() -> *mut dyn janus_plugin_api::JanusPlugin {
